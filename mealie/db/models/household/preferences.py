...
class HouseholdPreferencesModel(SqlAlchemyBase, BaseMixins):
    ...
    default_shopping_list_id: FilterableColumn[GUID | None] = mapped_column(
    ...
    volume_display_mode: FilterableColumn[str] = mapped_column(sa.String, nullable=False, default="primary_only")
    mass_display_mode: FilterableColumn[str] = mapped_column(sa.String, nullable=False, default="primary_only")
    temperature_display_template: FilterableColumn[str] = mapped_column(sa.String, nullable=False, default="℃ / ℉")
